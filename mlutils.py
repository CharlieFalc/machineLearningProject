    ...
    for testFold in range(nFolds):
        ...
        for parms in parameterSets:
            ...
            for validateFold in range(nFolds):
                ...
                if verbose:
                    print('Test Fold {}, Parms {}, Validate Fold {} and Accuracy {:.2f}'.format(testFold,parms,validateFold,validateAccuracy))
            validateAccuracy = validateAccuracySum / nFolds
